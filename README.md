...
5. Si el cliente es de **reparto propio**, ese pedido sigue viéndose en la
   ...
   pulsar "Pasar a OK albarán sin subir nada" si no lo necesita.
...
Dentro de Clientes, la pestaña **"Vista semanal"** muestra, para la semana
que elijas (con ‹ › y "Hoy"), un punto de color por cliente:

- 🔴 **Rojo** — todavía no ha hecho pedido esta semana.
- 🟠 **Naranja** — ha entrado un pedido, pero aún no está "OK montado".
- 🟢 **Verde** — ya tiene el pedido montado (o más adelante en el proceso).
- ⚪ **Gris** — el cliente avisó que esta semana no quiere pedido; se marca
  con el botón "No quiere esta semana" que aparece junto a los que están en
  rojo, y así deja de contar como una falta. Se puede deshacer con "Sí
  quiere" en cualquier momento.

La lista se ordena sola: primero los rojos (los que hay que vigilar), luego
naranjas, verdes y grises al final. Se basa en la fecha en que se subió el
pedido (no en la fecha de reparto), así que si un pedido se sube el lunes
para repartir el jueves, ya cuenta como "hecho" desde el lunes.
